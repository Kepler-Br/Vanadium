...
class UserEndStateStack {
 ...
 public:
  ...
  [[nodiscard]] virtual State *get(VNsize index) const noexcept = 0;
  [[nodiscard]] virtual VNsize size() const noexcept = 0;
...
class StateStack : public UserEndStateStack {
 ...
 public:
  ...
  [[nodiscard]] State *get(VNsize index) const noexcept override;
  [[nodiscard]] VNsize size() const noexcept override;
