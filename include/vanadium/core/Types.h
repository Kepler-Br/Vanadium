...
static VNsize dataTypeToSize(DataTypes dataType) {
  switch (dataType) {
    case DataTypes::UByte:
      return sizeof(VNubyte);
    case DataTypes::Byte:
      return sizeof(VNbyte);
    case DataTypes::Char:
      return sizeof(VNchar);
    case DataTypes::UInt:
      return sizeof(VNuint);
    case DataTypes::Int:
      return sizeof(VNint);
    case DataTypes::Int2:
      return sizeof(VNint) * 2;
    case DataTypes::Int3:
      return sizeof(VNint) * 3;
    case DataTypes::Int4:
      return sizeof(VNint) * 4;
    case DataTypes::Size:
      return sizeof(VNsize);
    case DataTypes::Float:
      return sizeof(VNfloat);
    case DataTypes::Float2:
      return sizeof(VNfloat) * 2;
    case DataTypes::Float3:
      return sizeof(VNfloat) * 3;
    case DataTypes::Float4:
      return sizeof(VNfloat) * 4;
    case DataTypes::Double:
      return sizeof(VNdouble);
    case DataTypes::Mat3:
      return sizeof(VNfloat) * 3 * 3;
    case DataTypes::Mat4:
      return sizeof(VNfloat) * 4 * 4;
    case DataTypes::Bool:
      return sizeof(VNbool);
  }
  return 0;
}
