...
class MouseMoveEvent : public Event {
 ...
 public:
  MouseMoveEvent(int32_t newXPosition, int32_t newYPosition, int32_t deltaX,
                 int32_t deltaY, void *raw = nullptr, VNsize rawSize = 0)
      : Event(raw, rawSize),
...
class MouseScrollEvent : public Event {
 ...
 public:
  MouseScrollEvent(VNint vertical, VNint horizontal, void *raw = nullptr,
                   VNsize rawSize = 0)
      : Event(raw, rawSize),
        verticalScroll(vertical),
        horizontalScroll(horizontal) {}
  [[nodiscard]] VNint getVerticalScroll() const noexcept {
    return this->verticalScroll;
  }
  [[nodiscard]] VNint getHorizontalScroll() const noexcept {
