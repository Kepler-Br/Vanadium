...
class OpenGLShader : public Shader {
 ...
 public:
  //    OpenGLShader(const std::string &shaderName, const std::string &vertex,
  ...
  void setGlobalFloat2(const std::string &name,
                       const glm::vec2 &value) override;
  void setGlobalFloat3(const std::string &name,
                       const glm::vec3 &value) override;
  void setGlobalFloat4(const std::string &name,
