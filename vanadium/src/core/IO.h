...
public:
    ...
    virtual std::vector<char> readFile(const std::string &path) noexcept = 0;
    virtual void writeFile(const std::string &path, void *data, VNsize dataSize, bool overwrite) noexcept = 0;
