...
class Texture {
 ...
 public:
  [[nodiscard]] virtual VNsize getWidth() const noexcept = 0;
  [[nodiscard]] virtual VNsize getHeight() const noexcept = 0;
  ...
  virtual void setMagnificationFiltering(
      Texture::Filtering filtering) noexcept = 0;
  virtual void setMinificationFiltering(
      Texture::Filtering filtering) noexcept = 0;
  [[nodiscard]] virtual const Texture::Specification &getSpecification()
      const noexcept = 0;
...
class TextureFactory {
 public:
  static Ref<Texture> create(
      ...
      Texture::Specification specification = Texture::Specification());
  static Ref<Texture> create(
      void *data,
      const Texture::Specification &specification = Texture::Specification());
};
